...
CREATE TABLE IF NOT EXISTS `automotriz_delux`.`sub_orders` (
  ...
  `order_status` VARCHAR(1) NULL DEFAULT NULL,
  `delivery_date` DATETIME NULL DEFAULT NULL,
  `days_delay` INT NULL DEFAULT NULL,
  PRIMARY KEY (`order_number`),
  CONSTRAINT `sub`
...
CREATE TABLE IF NOT EXISTS `automotriz_delux`.`sub_order_items` (
  ...
  CONSTRAINT `order`
    FOREIGN KEY (`order_id`)
    REFERENCES `automotriz_delux`.`sub_orders` (`order_number`),
  CONSTRAINT `partid`
    FOREIGN KEY (`part_id`)
    REFERENCES `automotriz_delux`.`parts` (`part_code`))
ENGINE = InnoDB
...
-- create sub_orders
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (1, 5, '2021-04-30 20:23:06', 'P', '2021-05-15 20:23:06', 0);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (2, 5, '2020-09-15 21:49:21', 'D', '2020-09-20 21:49:21', 0);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (3, 1, '2021-04-03 16:00:53', 'F', '2021-05-03 16:00:53', 3);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (4, 4, '2020-07-06 20:23:40', 'C', '2020-08-06 20:23:40', 4);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (5, 4, '2021-01-04 05:38:39', 'F', '2021-03-04 05:38:39', 0);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (6, 5, '2020-06-02 20:19:01', 'P', '2020-07-02 20:19:01', 0);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (7, 4, '2021-03-15 17:53:03', 'C', '2021-05-15 17:53:03', 1);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (8, 3, '2021-03-24 21:14:13', 'D', '2021-03-30 21:14:13', 2);
insert into sub_orders (order_number, subsidiary_id, order_date, order_status, delivery_date, days_delay) values (9, 3, '2020-11-30 14:48:08', 'F', '2020-12-15 14:48:08', 0);
...
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (1, 1, 1, 2, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (2, 2, 2, 2, 'R', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (3, 2, 3, 1, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (4, 3, 4, 4, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (5, 3, 5, 2, 'R', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (6, 5, 5, 1, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (7, 6, 6, 3, 'R', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (8, 7, 10, 4, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (9, 8, 10, 5, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (10, 8, 11, 2, 'G', "sin motivo");
insert into dealer_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (11, 9, 10, 3, 'R', "sin motivo");

-- create sub_order_items
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (1, 1, 4, 2, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (2, 2, 3, 2, 'R', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (3, 3, 1, 1, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (4, 3, 4, 4, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (5, 4, 5, 2, 'R', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (6, 4, 5, 1, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (7, 5, 6, 3, 'R', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (8, 5, 10, 4, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (9, 6, 10, 5, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (10, 8, 11, 2, 'G', "sin motivo");
insert into sub_order_items (id_order_items, order_id, part_id, quantity, account_type, reason) values (11, 9, 10, 3, 'R', "sin motivo");
